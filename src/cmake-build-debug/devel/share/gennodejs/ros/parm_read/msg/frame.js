...
class frame {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _arraySerializer.float64(obj.data, buffer, bufferOffset, 2);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.data = _arrayDeserializer.float64(buffer, bufferOffset, 2)
    return data;
  }
