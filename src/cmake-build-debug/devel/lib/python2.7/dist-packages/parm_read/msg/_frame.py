...
"""autogenerated by genpy from parm_read/frame.msg. Do not edit."""
import sys
...
"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_get_struct_2d().pack(*self.data))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.data = _get_struct_2d().unpack(str[start:end])
      return self
